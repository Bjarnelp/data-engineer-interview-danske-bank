...
For data processing the Polars library was chosen. The reason for this is, that Polars is high-performance on medium sized datasets while being lightweight enough to run on a standalone computer. Moreover the syntax for Polars to a great extent resembles that of Apache Spark.
